...
CREATE TABLE batch_program (
	batch_program_id INT AUTO_INCREMENT,
	batch_id INT DEFAULT NULL,
	program_id INT DEFAULT NULL,
	CONSTRAINT pk_batch_program_id PRIMARY KEY (batch_program_id),
	CONSTRAINT fk_batch_program_batch_id FOREIGN KEY (batch_id) REFERENCES batch (batch_id) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT fk_batch_program_program_id FOREIGN KEY (program_id) REFERENCES program (program_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE evaluation_name (
    ...
    CONSTRAINT fk_evaluation_name_course_id FOREIGN KEY (course_id)
        REFERENCES course (course_id)
        ON DELETE CASCADE,
    CONSTRAINT fk_evaluation_name_teacher_id FOREIGN KEY (teacher_id)
        REFERENCES teacher (teacher_id)
        ON DELETE CASCADE,
    CONSTRAINT fk_evaluation_name_batch_id FOREIGN KEY (batch_id)
        REFERENCES batch (batch_id)
        ON DELETE CASCADE,
    CONSTRAINT fk_evaluation_name_student_id FOREIGN KEY (student_id)
...
CREATE TABLE attendance (
    ...
    CONSTRAINT fk_attendance_student_id FOREIGN KEY (student_id)
        REFERENCES student (student_id)
        ON DELETE CASCADE,
    CONSTRAINT fk_attendance_topic_id FOREIGN KEY (topic_id)
        REFERENCES topic (topic_id)
        ON DELETE CASCADE,
    CONSTRAINT fk_attendance_teacher_id FOREIGN KEY (teacher_id)
        REFERENCES teacher (teacher_id)
        ON DELETE CASCADE,
    CONSTRAINT fk_attendance_batch_id FOREIGN KEY (batch_id)
        REFERENCES batch (batch_id)
        ON DELETE CASCADE
);