...
export class ExamsComponent {
 ...
 batchID:any; 
  ...
  async ngOnInit() {
    ...
    ELEMENT_DATA= await this.commonService.getList('/exam/all').toPromise();
    ...
    this.commonService.getList('/exam/batch/all').subscribe((data:any)=>{
      this.batches=data;
      console.log(this.batches);
    })
    this.commonService.getList('/exam/program/all').subscribe((data:any)=>{
      this.programs=data;
      console.log(this.programs);
    })
    this.commonService.getList('/exam/course/all').subscribe((data:any)=>{
      this.courses=data;
    })
...
this.commonService.getCoursesByProgram("/exam/courses",programID).subscribe((response: any) => {
     
  this.courses = response;
  console.log(this.courses);
    });

this.commonService.getStudentByProgramIdandBatchId("/exam/students",programID,this.batchID).subscribe((response: any) => {
...
    });
  ...
  onCourseSelected(){
    ...
    this.commonService.getTopicByCourseId("/exam/topic",courseID).subscribe((response:any)=>{
  ...
  deleteRow(index: number, key = '') {
    ...
    dialogRef.afterClosed().subscribe((res) => {
      ...
      this.commonService
        .deleteData(control.controls[index].value.evaluationId, '/exam/delete')
        .subscribe(
          (res) => {
            console.log(res);
          },
  ...
  SaveVO(VOFormElement: any, i: any) {
    ...
    if (VOFormElement.get('VORows').at(i).value.id) {
      ...
      this.commonService
        ...
        .addData('/exam/add', VOFormElement.get('VORows').at(i).value)
        .subscribe(
          (res) => {
            console.log(res);
          },
