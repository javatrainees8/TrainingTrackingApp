...
export class AssigmentComponent {
  ...
  async ngOnInit(){
    ...
    ELEMENT_DATA= await this.commonService.getList('/assignment/all-assignments').toPromise();
    ...
    this.commonService.getList('/student/all').subscribe(
      (data: any) => {
  ...
  deleteRow(index: number, key = '') {
    ...
    dialogRef.afterClosed().subscribe((res) => {
      const control = this.VOForm.get('VORows') as FormArray;
      this.commonService
        .deleteData(control.controls[index].value.id, '/assigment/delete-assignment')
        .subscribe(
          (res) => {
            console.log(res);
          },
  ...
  SaveVO(VOFormElement: any, i: any) {
    ...
    if (VOFormElement.get('VORows').at(i).value.id) {
      this.commonService
        .addData('/assigment/add-assignment', VOFormElement.get('VORows').at(i).value)
        .subscribe(
          (res) => {
            console.log(res);
          },
